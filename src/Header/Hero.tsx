...
import { BlueButtonSmall, GreenButton, GreenButtonSmall } from '../components/Buttons/Buttons';

export default function Hero() {
    return (
        <div className="hero-container pt-10 sm:pt-16 lg:pt-8 lg:overflow-hidden">
                    ...
                    <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                        <div className="lg:py-24">
                            ...
                            <div className="flex pt-12">
                                <GreenButtonSmall href={''}>Invest</GreenButtonSmall>
                                <div className="pl-4">
                                    <BlueButtonSmall href={''}>Trade</BlueButtonSmall>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="mt-12 -mb-16 sm:-mb-48 lg:m-0 lg:relative flex">
                        <div className="flex-1" />
                        <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 items-right flex justify-end">
                            <img src={HeroImage} width="453" />
                        </div>
                    </div>
                </div>
            </div>
